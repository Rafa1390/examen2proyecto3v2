...
public class Professor implements Serializable {
    ...
    public Professor surname(String surname) {
    ...
    public Professor secondSurname(String secondSurname) {
    ...
    public Professor sex(String sex) {
        this.sex = sex;
        return this;
    }
    ...
    public Professor hiringDate(LocalDate hiringDate) {
